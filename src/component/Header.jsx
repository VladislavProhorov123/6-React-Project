        ...
        <div className="flex items-center gap-8 w-full md:w-auto">
          ...
          <nav className="">
            <ul className="flex gap-9">
              ...
              <li className="hover:text-gray-300 transition-colors cursor-pointer">Price</li>
            </ul>
          </nav>
        </div>
        <input className="px-4 py-2 rounded bg-gray-800 text-white placeholder-gray-400 w-[400px]" type="search" placeholder="Enter movie..." />
      </header>
    </>
  );
}
